...
<div class="midbody">
    ...
    <div class="logined">
        ...
        <div class="logined_userinfo">
            <img src="/pic/${sessionScope.users.headphoto}" width="100px" height="100px">
    ...
    <div class="articles">
        ...
        <div class="pagenum">
            ...
            <c:if test="${pageBean.pageNow!=1}">
                <a href="/${pageBean.pageNow-1}">上一页</a>
            </c:if>
            ...
            <c:if test="${pageBean.pageNow!=pageBean.pages}">
                <a href="/${pageBean.pageNow+1}">下一页</a>
            </c:if>
        </div>
